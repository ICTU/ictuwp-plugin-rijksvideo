...
class MetaFlexSlider extends MetaSlider {
    ...
    public function enqueue_scripts() {
        ...
        if ( $this->get_setting( 'printJs' ) == 'true' && ( $this->get_setting( 'effect' ) == 'slide' || $this->get_setting( 'carouselMode' ) == 'true' ) ) {
            wp_enqueue_script( 'metaslider-easing', RIJKSVIDEO_ASSETS_URL . 'easing/jQuery.easing.min.js', array( 'jquery' ), RIJKSVIDEO_VERSION );
        }
    }
    ...
    protected function get_html() {
        ...
        foreach ( $this->slides as $slide ) {
            // backwards compatibility with older versions of Rijksvideo Pro (< v2.0)
