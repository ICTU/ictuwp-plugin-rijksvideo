...
class MetaSlider {
    ...
    private function get_settings() {
        $settings = get_post_meta( $this->id, 'rijksvideo_settings', true );
    ...
    private function populate_slides() {
        ...
        while ( $query->have_posts() ) {
            ...
            $type = get_post_meta( $query->post->ID, 'rijksvideo_type', true );
    ...
    public function enqueue_scripts() {
        if ( $this->get_setting( 'printJs' ) == 'true' ) {
            wp_enqueue_script( 'metaslider-' . $this->get_setting( 'type' ) . '-slider', RIJKSVIDEO_ASSETS_URL . $this->js_path, array( 'jquery' ), RIJKSVIDEO_VERSION );
        }
        ...
        if ( $this->get_setting( 'printCss' ) == 'true' ) {
            ...
            wp_enqueue_style( 'metaslider-' . $this->get_setting( 'type' ) . '-slider', RIJKSVIDEO_ASSETS_URL . $this->css_path, false, RIJKSVIDEO_VERSION );
            wp_enqueue_style( 'metaslider-public', RIJKSVIDEO_ASSETS_URL . 'metaslider/public.css', false, RIJKSVIDEO_VERSION );
        }
