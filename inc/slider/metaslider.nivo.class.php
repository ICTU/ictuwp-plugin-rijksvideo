...
class MetaNivoSlider extends MetaSlider {
    ...
    public function enqueue_scripts() {
        ...
        if ( $this->get_setting( 'printCss' ) == 'true' ) {
            ...
            wp_enqueue_style( 'metaslider-' . $this->get_setting( 'type' ) . '-slider-'.$theme, RIJKSVIDEO_ASSETS_URL . "sliders/nivoslider/themes/{$theme}/{$theme}.css", false, RIJKSVIDEO_VERSION );
        }
    }
