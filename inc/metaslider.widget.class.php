...
class MetaSlider_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Rijksvideo', // Name
			array( 'description' => __( 'Rijksvideo', "rhswp-rijksvideo" ) ) // Args
		);
	}
...
?>
		<p>
			<?php if ( $sliders ) { ?>
				<p>
					<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', "rhswp-rijksvideo" ); ?></label>
					<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
				</p>
				<label for="<?php echo $this->get_field_id( 'slider_id' ); ?>"><?php _e( 'Select Slider:', "rhswp-rijksvideo" ); ?></label>
...
?>
			...
			<?php } else {
			_e( 'No slideshows found', "rhswp-rijksvideo" );
		} ?>
		</p>
		<?php
	}
