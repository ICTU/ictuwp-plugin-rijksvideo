...
* Free basic support
* Lightbox support with the [Rijksvideo Lightbox](http://wordpress.org/plugins/ml-slider-lightbox/) addon

Upgrade to [Rijksvideo Pro](https://www.metaslider.com/upgrade) to add support for:
...
1. Manage your slideshows using the 'Rijksvideo' menu option
...
= Rijksvideo is cropping my images in the wrong place - what can I do? =

See https://www.metaslider.com/documentation/image-cropping/

== Screenshots ==

1. Rijksvideo - for live demos see https://www.metaslider.com/examples/
...
* Prepare plugin for WordPress.org translation project (rename textdomain from 'rijksvideo' to 'rhswp-rijksvideo')
* Small styling fix
...
* Fix: Rijksvideo hoplink incorrectly adding parameters to filtered url
...
The fix will prevent some servers (configured with 'display_errors' set to 'on') from disclosing the full path to certain files within Rijksvideo.

http://codex.wordpress.org/Security_FAQ#Why_are_there_path_disclosures_when_directly_loading_certain_files.3F

= 3.3.1 [23/03/15] =

* Fix: Remove 'create video playlist' option from Media Library (on Rijksvideo page only)
